...
class HomeState extends State<Home> {
          ...
          child: FloatingActionButton(
            ...
            onPressed: () async {
              await navigateToEntryForm(
                  context, null, id, null, null, null, null, null);
            },
          ),
        ),
      ),
  ...
  Future<Item> navigateToEntryForm(BuildContext context, Item item, String id,
    ...
    var result = await Navigator.push(context,
      ...
      return EntryForm(item, id, nama, kategori, stok, price, docID);
    }));
    return result;
  }
                    ...
                    child: DropdownButton<String>(
                      ...
                      onChanged: (String changeValue) async {
                        if (changeValue == "Delete") {
                          ...
                          await navigateToEntryForm(context, null, a, name,
                              kategori, price, stock, docID);
                        }
                        ;
                      },
                    ),
