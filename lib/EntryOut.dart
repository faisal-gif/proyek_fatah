...
class EntryOut extends StatefulWidget {
  ...
  EntryOut(this.item, this.id, this.nama, this.kategori, this.stok, this.price,
      this.docId);
  @override
  EntryOutState createState() => EntryOutState(this.item, this.id, this.nama,
      this.kategori, this.stok, this.price, this.docId);
}

//class controller
class EntryOutState extends State<EntryOut> {
  Item item;
  String id;
  String nama;
  String kategori;
  ...
  int stok;
  int price;
  EntryOutState(this.item, this.id, this.nama, this.kategori, this.stok,
